      ...
      <Container maxW={'7xl'}>
        <Stack
          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text color={'teal.500'}>
            The usd to rai extension serves to convert all dollars on any page to our beloved RAI token
            </Text>
            <Stack
              spacing={{ base: 4, sm: 6 }}
          ...
          <Flex
            ...
            <Box
              ...
              <Image
                ...
                h={'100%'}
                src={
                  'https://siasky.net/nAAhoLqzAQanAhx0WEEk9Qhu6ju0tY4jVzclgIxPPtuBig'
                }
              />
            </Box>
          </Flex>
